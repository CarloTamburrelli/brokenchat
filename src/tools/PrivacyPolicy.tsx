...
const PrivacyPolicy: React.FC = () => {
  return (
    ...
    <p className="mb-1 text-sm text-gray-500">Created: May 5, 2025</p>
    ...
    <section className="mb-8">
      <h2 className="text-xl font-semibold mb-2">8. Data Recipients</h2>
      <p>
    ...
    <section className="mb-8">
      <h2 className="text-xl font-semibold mb-2">9. Transfer of Data Outside the EU</h2>
      <p>
    ...
    <section className="mb-8">
      <h2 className="text-xl font-semibold mb-2">10. Data Retention Period</h2>
      <p>
